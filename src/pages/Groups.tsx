                ...
                <div key={group.id} className="p-4 rounded-xl border bg-card">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Link to={`/my-labs/${group.id}`} className="text-xs text-primary hover:underline">Open</Link>
                    </div>
                  </div>
                  {isExpanded && (
                ...
                return (
                  <div key={inv.id} className="p-4 rounded-xl border bg-card">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <Link to={`/my-labs/${group.id}`} className="text-xs text-primary hover:underline">View group</Link>
                    </div>
