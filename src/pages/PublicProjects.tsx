      ...
      <nav className={cn(
        ...
        <div className="container flex items-center justify-between px-4 sm:px-6 h-16">
          ...
          <div className="hidden md:flex items-center gap-1 ml-auto mr-4">
            <Link to="/" className="px-4 py-2 text-sm font-medium rounded-md transition-colors text-[#475569] hover:text-[#0F172A] hover:bg-gray-100">
              Home
            </Link>
            <span className="relative px-4 py-2 text-sm font-medium rounded-md text-[#0F172A]">
              Projects
